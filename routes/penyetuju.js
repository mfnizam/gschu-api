...
router.patch('/persetujuan/setuju', async (req, res) => {
  try {
    ...
    await Notifikasi.create({
      ...
      konten: permintaan.kategori.nama + ' anda dengan No Surat ' + permintaan.noSurat + ' telah disetujui oleh ' + (permintaan.disetujui?.oleh?.fungsi?.nama || 'SCM & Asset') + ' - ' +
...
router.patch('/persetujuan/tolak', async (req, res) => {
  try {
    ...
    await Notifikasi.create({
      ...
      konten: permintaan.kategori.nama + ' anda dengan No Surat ' + permintaan.noSurat + ' telah ditolak oleh ' + (permintaan.disetujui?.oleh?.fungsi?.nama || 'SCM & Asset') + ' - ' +
        capitalize(permintaan.disetujui?.oleh?.namaLengkap) + '( ' + permintaan.disetujui?.oleh?.jabatan?.nama + ' )' +
...
router.patch('/persetujuan/selesai', async (req, res) => {
  try {
    ...
    await Notifikasi.create({
      ...
      konten: permintaan.kategori.nama + ' anda dengan No Surat ' + permintaan.noSurat + ' telah selesai. Beri ulasan permintaan anda supaya dapat membantu kami untuk terus memberikan pelayanan terbaik.',
      tombol: {
